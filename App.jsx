...
// Optimization: Removed unused currentTime state to prevent 1Hz re-renders of the entire App tree
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-purple-100">
                    Optimisez votre apprentissage avec la science du cerveau
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Optimise la consolidation mnésique selon la courbe d'oubli",
                  icon: Clock,
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div
                        className={`w-12 h-12 bg-gradient-to-r ${technique.gradient} rounded-xl flex items-center justify-center shadow-lg`}
                      >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-2">
                          ...
                          <Progress
                            value={technique.progress}
                            className="h-2"
                          />
                        </div>
                        <Button
                          className={`mt-4 bg-gradient-to-r ${technique.gradient} hover:shadow-lg transition-all duration-200`}
                          size="sm"
                        >
                          Pratiquer
                        </Button>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">
                    Votre tuteur personnel disponible 24h/24
                  </p>
                </div>
              </div>
            </div>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Questions personnalisées selon votre niveau",
                      icon: Target,
                      gradient: "from-blue-500 to-cyan-500",
                    },
                    {
                    ...
                    <Button
                      key={index}
                      variant="outline"
                      className="h-auto p-6 text-left border-2 hover:border-green-300 hover:shadow-lg transition-all duration-200 group"
                    >
                      <div className="flex items-start gap-4">
                        <div
                          className={`w-10 h-10 bg-gradient-to-r ${tool.gradient} rounded-lg flex items-center justify-center`}
                        >
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl p-6 text-white">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold">
                    Deep Work & Productivité
                  </h2>
                  <p className="text-orange-100">
                    Optimisez vos sessions selon votre chronotype
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${item.gradient} rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 transition-transform duration-200`}
                    >
                    ...
                    <Badge
                      className={`mb-4 bg-gradient-to-r ${item.gradient} text-white border-0`}
                    >
                      {item.status}
                    </Badge>
                    <Button
                      className={`w-full bg-gradient-to-r ${item.gradient} hover:shadow-lg transition-all duration-200`}
                      size="sm"
                    >
                      {item.action}
                    </Button>
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-pink-100">
                    Rejoignez des groupes d'étude et bénéficiez de mentorat
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Groupe d'étude intensif pour atteindre 800+ points",
                  status: "Actif",
                ...
                >
                  <CardContent className="p-6">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            {item.members} • {item.nextSession}
                          </p>
                        </div>
                      </div>
                      <Badge
                        className={`${item.statusColor} text-white border-0`}
                      >
                        {item.status}
                      </Badge>
                    </div>
                    ...
                    <Button
                      className={`bg-gradient-to-r ${item.gradient} hover:shadow-lg transition-all duration-200`}
                      size="sm"
                    >
                      {index === 0
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-100">
                    Analyse détaillée de vos performances et recommandations
                  </p>
                </div>
              </div>
            </div>
                ...
                <CardContent>
                  <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 text-center">
                    ...
                    <div className="text-lg font-semibold text-gray-800 mb-1">
                      Probabilité d'atteindre 800
                    </div>
                    <div className="text-sm text-gray-600">
                      Estimation: 15 Sept 2024
                    </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  IA & Neurosciences pour le TOEIC
                </p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <div className="text-xs text-gray-500">
                  Objectif: {progressData.targetScore}
                </div>
              </div>
              <Button
                variant="outline"
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-xs mb-2">
                      ...
                      <span className="font-semibold text-blue-600">
                        {Math.round(
                          ((progressData.currentScore - 400) /
                            (progressData.targetScore - 400)) *
                            100,
                        )}
                        %
                      </span>
                  ...
                  <div className="text-xs text-gray-500 bg-blue-50 rounded-lg p-3">
                    Vous êtes à{" "}
                    <span className="font-semibold text-blue-600">
                      {progressData.targetScore - progressData.currentScore}{" "}
                      points
                    </span>{" "}
                    de votre objectif
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2">
                    {[
                      ...
                      },
                      {
                        ...
                        value: `${progressData.totalHours}h`,
                        icon: Clock,
                      },
                      {
                        label: "Streak moyen",
                        value: `${progressData.averageStreak} jours`,
                        icon: Award,
                      },
                    ].map((stat, index) => (
                      <div
                        key={index}
                        className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 text-center"
                      >
              ...
              <CardContent className="space-y-3">
                {recommendations.map((rec, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`bg-gradient-to-r ${rec.color} rounded-xl p-4 text-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105`}
                    >
