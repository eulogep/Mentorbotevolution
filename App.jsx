...
function App() {
  ...
  // OPTIMIZATION: Removed unused `currentTime` state that was causing 1Hz re-renders
  // OPTIMIZATION: Moved `progressData`, `recommendations`, and `modules` outside component to prevent re-creation
