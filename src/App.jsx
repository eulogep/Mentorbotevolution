...
// Données de progression simulées - Moved outside component to prevent recreation on render
const progressData = {
  currentScore: 650,
  targetScore: 800,
  listening: 340,
...
function App() {
  ...
  // Removed unused currentTime state that was causing re-renders every second
