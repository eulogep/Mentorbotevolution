...
// ⚡ PERFORMANCE OPTIMIZATION: Moved static data outside component to prevent recreation on every render.
...
function App() {
  ...
  // ⚡ PERFORMANCE OPTIMIZATION: Removed unused currentTime state that was causing re-renders every second.
