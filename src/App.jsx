...
// Optimization: Moved static data outside the component to prevent unnecessary recreation on every render.
...
function App() {
  ...
  // Optimization: Removed unused currentTime state and useEffect interval which caused re-renders every second.
